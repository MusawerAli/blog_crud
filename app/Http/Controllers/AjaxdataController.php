...
class AjaxdataController extends Controller
{
    ...
    function postdata(Request $request){
    	...
    	if($validation->fails())
    	{
    		foreach($validation->message()->getMessages() as $field_name => $message)
    		{
    			$error_array[] = $message;
    		}
    	}
    	else
    	{
    		if($request->get('button_action') =="insert")
    		{
				...
				$student->save();
				$success_output = '<div class="alert alert-success alert-dismissible">
				<button type="button" class="close" data-dismiss="alert">&times;</button>
				<strong>Addeed!</strong> Success
			  </div>';
			}
			...
			if($request->get('button_action')=="update"){
				...
				$success_output ='<div class="alert alert-warning alert-dismissible">
				<button type="button" class="close" data-dismiss="alert">&times;</button>
